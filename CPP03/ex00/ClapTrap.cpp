...
/*   Updated: 2025/02/10 16:28:12 by vbritto-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
    std::cout << "Defaut constroctor was called" << std::endl;
    this->name = "";
    this->hit = 10;
    this->energy = 10;
...
ClapTrap::ClapTrap(std::string name)
{
    ...
    this->energy = 10;
    this->attack_damage = 0;
    std::cout << this->name << ": constroctor was called" << std::endl;
}
ClapTrap:: ~ClapTrap()
{
    std::cout << this->name << ": Destroctor was called" << std::endl;
}
